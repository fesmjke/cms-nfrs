...
import { PostUserSchema,PostUserResponce } from "../../types/schema/user";
...
class UserRoute extends Route {
    ...
    */
    ...
    constructor(rootLabel : string,userController : IController) {
        ...
        this.getUsersRoute = { method : "GET",url : `/api/${this._rootLabel}`,handler : this._controller.getAll }
        this.getUserRoute = { method : "GET",url : `/api/${this._rootLabel}/:id`,handler : this._controller.getById }
        ...
        this.postUserRoute
        this.putUserRoute = { method : "PUT", url : `/api/${this._rootLabel}/:id`, handler : this._controller.updateById }
        this.deleteUserRoute = { method : "DELETE", url : `/api/${this._rootLabel}/:id`, handler : this._controller.deleteById }
    }
