...
class UserRoute extends Route {
    ...
    */
    ...
    constructor(rootLabel : string,userController : IController) {
        ...
        this.getUsersRoute = { method : "GET",url : `/api/${this._rootLabel}`,schema : {response : GetUsersResponce},handler : this._controller.getAll,onRequest : authService.authCheck }
        ...
        this.deleteUserRoute = { method : "DELETE", url : `/api/${this._rootLabel}/:id`,schema : {response : DeleteUserResponce}, handler : this._controller.deleteById,onRequest : authService.authCheck }
    }
